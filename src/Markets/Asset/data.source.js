...
export const Content30DataSource = {
  wrapper: { className: 'home-page-wrapper asset_content3-wrapper' },
  page: { className: 'home-page asset_content3' },
  ...
  block: {
    className: 'asset_content3-block-wrapper',
    children: [
      {
        name: 'block0',
        className: 'asset_content3-block',
        md: 24,
        xs: 24,
        children: {
          icon: {
           
            className: 'asset_content3-icon',
            md: 12,
            xs: 24,
            children:
              'https://bucket.mlcdn.com/a/1736/1736632/images/b007a8a5f49f743c1ab1d629ca292248c781be82.png',
          },
          textWrapper: { className: 'asset_content3-text' , md: 12, xs: 24 },
          title: { className: 'asset_content3-title', children: 'Food Delivery' },
          content: {
            className: 'asset_content3-content',
            children:
      ...
      },
      {
        ...
        children: {
          ...
          textWrapper: { className: 'asset_content3-text' , md: 12, xs: 24 },
          title: { className: 'asset_content3-title', children: 'No Interruption' },
          content: {
            className: 'asset_content3-content',
            children:
      ...
      //     },
      //     textWrapper: { className: 'asset_content3-text' },
      //     title: { className: 'asset_content3-title', children: '云监控' },
      //     content: {
      //       className: 'asset_content3-content',
      //       children:
      ...
      //     },
      //     textWrapper: { className: 'asset_content3-text' },
      //     title: { className: 'asset_content3-title', children: '移动' },
      //     content: {
      //       className: 'asset_content3-content',
      //       children:
      ...
      //     },
      //     textWrapper: { className: 'asset_content3-text' },
      //     title: { className: 'asset_content3-title', children: '分布式中间件' },
      //     content: {
      //       className: 'asset_content3-content',
      //       children:
      ...
      //     },
      //     textWrapper: { className: 'asset_content3-text' },
      //     title: { className: 'asset_content3-title', children: '大数据' },
      //     content: {
      //       className: 'asset_content3-content',
      //       children:
...
export const Feature70DataSource = {
  wrapper: { className: 'home-page-wrapper asset_feature7-wrapper' },
  page: { className: 'home-page asset_feature7' },
  OverPack: { playScale: 0.3 },
  titleWrapper: {
    className: 'asset_feature7-title-wrapper',
    children: [
      {
        name: 'title',
        className: 'asset_feature7-title-h1',
        children: '图像在线服务',
      },
      {
        name: 'content',
        className: 'asset_feature7-title-content',
        children: '你可以直接快速接入图像能力',
      },
    ],
  },
  blockWrapper: {
    className: 'asset_feature7-block-wrapper',
    gutter: 24,
    children: [
      {
        md: 6,
        xs: 24,
        name: 'block0',
        className: 'asset_feature7-block',
        children: {
          className: 'asset_feature7-block-group',
          children: [
            {
              name: 'image',
              className: 'asset_feature7-block-image',
              children:
                'https://bucket.mlcdn.com/a/1736/1736632/images/acfe55401bfc35949aaa9b49ac9b3fb6ec4a1df7.png',
            },
            {
              name: 'title',
              className: 'asset_feature7-block-title',
              children: '',
            },
            {
              name: 'content',
              className: 'asset_feature7-block-content',
