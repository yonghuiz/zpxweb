...
export const Content30DataSource = {
  ...
  block: {
    ...
    children: [
      ...
      //     },
      //     textWrapper: { className: 'eCommerce_content3-text' },
      ...
      //     },
      //     textWrapper: { className: 'eCommerce_content3-text' },
      //     title: { className: 'eCommerce_content3-title', children: '移动' },
      //     content: {
      //       className: 'eCommerce_content3-content',
      //       children:
      ...
      //     },
      //     textWrapper: { className: 'eCommerce_content3-text' },
      //     title: { className: 'eCommerce_content3-title', children: '分布式中间件' },
      //     content: {
      //       className: 'eCommerce_content3-content',
      //       children:
      ...
      //     },
      //     textWrapper: { className: 'eCommerce_content3-text' },
      //     title: { className: 'eCommerce_content3-title', children: '大数据' },
      //     content: {
      //       className: 'eCommerce_content3-content',
      //       children:
